...
class Musics {
    ...
    constructor() {
        this.songs = [{
                ...
                title: 'ANTIFRAGILE',
                singer: 'LE SSERAFIM',
                songUrl: './songs/ANTIFRAGILE - LE SSERAFIM.mp3',
                imageUrl: './images/songs/ANTIFRAGILE - LE SSERAFIM.jpg'
            },
            {
                id: 2,
                title: 'Eve, Psyche & The Bluebeards wife',
                singer: 'LE SSERAFIM',
                songUrl: './songs/Eve, Psyche & The Bluebeards wife - LE SSERAFIM.mp3',
                imageUrl: './images/songs/Eve, Psyche & The Bluebeards wife - LE SSERAFIM.jpg'
            },
			{
                id: 3,
                title: 'FEARLESS',
                singer: 'LE SSERAFIM',
                songUrl: './songs/FEARLESS - LE SSERAFIM.mp3',
                imageUrl: './images/songs/FEARLESS - LE SSERAFIM.jpg'
            },
            {
                id: 4,
                title: 'METAMORPHOSIS',
                singer: 'InterWorld',
                songUrl: './songs/METAMORPHOSIS.mp3',
                imageUrl: './images/songs/METAMORPHOSIS.jpg'
            },
			{
                id: 5,
                title: 'アイドル (IDOL)',
                singer: 'YOASOBI',
                songUrl: './songs/YOASOBI - アイドル.mp3',
                imageUrl: './images/songs/YOASOBI - アイドル.jpg'
            },
            {
                id: 6,
                title: 'ghệ iu dấu của em ơi',
                singer: 'tlinh',
                songUrl: './songs/ghệ iu dấu của em ơi - tlinh.mp3',
                imageUrl: './images/songs/ghệ iu dấu của em ơi - tlinh.jpg'
            },
            {
                id: 7,
                title: 'Reminder',
                singer: 'The Weeknd',
                songUrl: './songs/The Weeknd - Reminder.mp3',
                imageUrl: './images/songs/The Weeknd - Reminder.jpg'
            },
            {
                id: 8,
                title: 'リルビ little bit',
                singer: 'ロボ子さん (Roboco-san)',
                songUrl: './songs/リルビ little bit - ロボ子さん.mp3',
                imageUrl: './images/songs/リルビ little bit - ロボ子さん.jpg'
            },
        ]
    }
    //根据索引获取歌曲的方法
